  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-evenly' }}>
        ...
        {quote ? quote.map((element: any, i: number) => {
          ...
          return <div key={i} className="card" style={{ width: '18rem', marginBottom: 25 }}>
            ...
            <ul style={{ alignItems: 'center', width: '100%' }} className="list-group list-group-flush">
              ...
              {element.payment_term.map((newElement: any, i: number) => {
                ...
                if (tempDate === next_payment_date) {
                  return element.balancePaid < tempTotal &&
                    <li key={i} style={{ color: color }} className="list-group-item"><b>RM {tempTotal}</b> before {tempDate}</li>
                } else {
                  return element.balancePaid < tempTotal &&
                    <li key={i} className="list-group-item"><b>RM {tempTotal}</b> before {tempDate}</li>
                }
