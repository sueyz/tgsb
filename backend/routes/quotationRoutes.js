...
const { registerQuotation, queryQuotation, getQuotationById, updateQuotation, deleteQuotation, uploadAttachments, uploadPdf, updateLock, unlockLock } = require('../controller/quotationController')
