...
const { registerQuotation, queryQuotation, getQuotationById, updateQuotation, deleteQuotation, uploadAttachments,deletePdf, uploadPdf, updateLock, unlockLock, getQuotationByInvoice } = require('../controller/quotationController')
