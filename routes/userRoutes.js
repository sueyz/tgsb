...
const {registerUser, loginUser, getMe, verifyToken, refreshToken, queryUser, getUserById, deleteUser, updateUser, uploadAvatar} = require('../controller/userController')
...
const storage = multer.diskStorage({
    destination: (req,file, cb) => {
        const destination = path.join(__dirname, '../../tgsb-frontend/public/media/profile');
