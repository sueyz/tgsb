...
const { registerQuotation, getAllUnlockQuotation , fetchAttachment, queryQuotation, getQuotationById, updateQuotation, deleteQuotation, uploadAttachments,deletePdf, uploadPdf, updateLock, unlockLock, getQuotationByInvoice } = require('../controller/quotationController')
...
router.get('/fetch/quotations/:id', fetchAttachment)
